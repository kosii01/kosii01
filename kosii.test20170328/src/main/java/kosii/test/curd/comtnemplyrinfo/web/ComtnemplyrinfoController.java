package kosii.test.curd.comtnemplyrinfo.web;
...
import kosii.test.curd.comtnemplyrinfo.service.impl.ComtnemplyrinfoService;
...
public class ComtnemplyrinfoController {
	...
	public String addComtnemplyrinfo(ComtnemplyrinfoVO comtnemplyrinfoVO,
		...
		status.setComplete();
		return "kosii/test/crud/comtnemplyrinfo/ComtnemplyrinfoList.do";
	}
